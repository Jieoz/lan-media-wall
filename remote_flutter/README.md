...
> **当前版本 `1.13.0+32`**(`pubspec.yaml`)。CI 从 pubspec 派生 `flutter build apk --build-name=1.13.0 --build-number=32` 把版本号烧进 APK;播放端 `build.gradle.kts` 也从同一行派生,改 pubspec 即全端同步。发版流程见根 README。
>
