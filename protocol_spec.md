...
```json
{"type":"transport_configure","payload":{"device_id":"and-hall-03","request_id":"transport-...","broker_host":"192.168.1.10","broker_port":8770,"use_wss":false}}
```

- 这是独立命令，播放器校验主机和端口后写盘、重建 transport，并回报 `pending.transport:"reconnecting"`。
