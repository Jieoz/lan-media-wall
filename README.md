...
**当前候选版本:`v1.18.7`**(单一真相源 `remote_flutter/pubspec.yaml` = `1.18.7+1187`；正式发布前必须分别从现网支持基线 `1.18.5 (1185)` 与 `1.18.6 (1186)` 通过控制端按 APK manifest 识别并远程升级，随后完成批量 Broker 迁移、回读与同步播放验收)。
