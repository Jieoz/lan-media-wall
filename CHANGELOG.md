...
## [Unreleased] — Phase B cache-cleanup wiring (candidate, not released)
...
- Not in this candidate: Phase C group realtime playlist editing, and any "apply-and-clean" composition that would couple cleanup to a specific `push_id` adoption. No release, tag, or device verification is claimed here; upstream owns independent review and exact-SHA cloud CI.
